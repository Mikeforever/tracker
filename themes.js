...
function dark_normie() {
	...
	Game.magic_meter_img= "./normal/items/magic.png";
	...
	Game.bombchu_img = "./normal/items/chu.png";
	...
	for (const key of Object.keys(Location_Logic)) {
		...
		if (temp >= 13 && temp <=15) {document.getElementById(key).style.backgroundImage = "url('./normal/areas/valley.jpg')";}
		if (temp >= 16 && temp <=21) {document.getElementById(key).style.backgroundImage = "url('./normal/areas/hylia.jpg')";}
		if (temp >= 22 && temp <=27) {document.getElementById(key).style.backgroundImage = "url('./normal/areas/market.jpg')";}
		if (temp >= 28 && temp <=28) {document.getElementById(key).style.backgroundImage = "url('./normal/areas/hyrule_castle.jpg')";}
		...
		if (temp >= 60 && temp <=66) {document.getElementById(key).style.backgroundImage = "url('./normal/areas/dodongos.jpg')";}
		if (temp >= 67 && temp <=71) {document.getElementById(key).style.backgroundImage = "url('./normal/areas/dmt.jpg')";}
		if (temp >= 72 && temp <=75) {document.getElementById(key).style.backgroundImage = "url('./normal/areas/dmc.jpg')";}
		if (temp >= 76 && temp <=88) {document.getElementById(key).style.backgroundImage = "url('./normal/areas/kakariko.jpg')";}
		...
		if (temp >= 101 && temp <=103) {document.getElementById(key).style.backgroundImage = "url('./normal/areas/domain.jpg')";}
		if (temp >= 104 && temp <=105) {document.getElementById(key).style.backgroundImage = "url('./normal/areas/colossus.jpg')";}
		if (temp >= 106 && temp <=106) {document.getElementById(key).style.backgroundImage = "url('./normal/areas/wasteland.jpg')";}
