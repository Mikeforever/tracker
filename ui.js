...
function process_inputs() {
	...
	for (const key of Object.keys(Location_Logic)) {
		...
		if (temp <= 244) { 
			...
			if (document.getElementById(key).value.toLowerCase() == "chu") {var obj = "chu"; Check[document.getElementById(key).id] = "chu"; Location.bombchus = document.getElementById(key).id; document.getElementById("bombchus_location").innerHTML = Names[temp-1]; Known.bombchus = true; if (!hinted && !peeked) {} if (hinted) {Hinted[key] = true;} if (hinted || peeked) {temptext2 += Names[temp - 1].split(': ')[1] + ":  BombChus" + "<br />";} junkItem(document.getElementById(key), obj); if (!Game.has_chus) {enableChus();} continue;}
			...
			if (document.getElementById(key).value == "len" && !Known.lens_of_truth) {var obj = "len"; Check[document.getElementById(key).id] = "lens_of_truth";Location.lens_of_truth = document.getElementById(key).id; document.getElementById("lens_of_truth_location").innerHTML = Names[temp-1]; Known.lens_of_truth = true; if (!hinted && !peeked) {Game.lens_of_truth = true; Game.lens = true;} if (hinted) {Hinted[key] = true;} if (hinted || peeked) {temptext2 += Names[temp - 1].split(': ')[1] + ":  Lens" + "<br />";} junkItem(document.getElementById(key), obj); continue;}
			...
			if (document.getElementById(key).value == "sun" && !Known.suns_song) {var obj = "sun"; Check[document.getElementById(key).id] = "suns_song";Location.suns_song = document.getElementById(key).id; Known.suns_song = true; if (!hinted && !peeked) {Game.suns_song = true;} if (hinted) {Hinted[key] = true;} if (hinted || peeked) {temptext2 += Names[temp - 1] + ": Suns" + "<br />";} var change = "text_" + document.getElementById(key).id; document.getElementById(change).innerHTML += ": Sun's"; backUp[temp-1] += ": Sun's"; junkSong(document.getElementById(key), obj); continue;}
			if (document.getElementById(key).value == "sot" && !Known.song_of_time) {var obj = "sot"; Check[document.getElementById(key).id] = "song_of_time";Location.song_of_time = document.getElementById(key).id; Known.song_of_time = true; if (!hinted && !peeked) {Game.song_of_time = true;} if (hinted) {Hinted[key] = true;} if (hinted || peeked) {temptext2 += Names[temp - 1] + ": Time" + "<br />";}var change = "text_" + document.getElementById(key).id; document.getElementById(change).innerHTML += ": Time"; backUp[temp-1] += ": Time"; junkSong(document.getElementById(key), obj); continue;}
			if (document.getElementById(key).value == "sos" && !Known.song_of_storms) {var obj = "sos"; Check[document.getElementById(key).id] = "song_of_storms"; Location.song_of_storms = document.getElementById(key).id; Known.song_of_storms = true; if (!hinted && !peeked) {Game.song_of_storms = true;} if (hinted) {Hinted[key] = true;} if (hinted || peeked) {temptext2 += Names[temp - 1] + ": Storms" + "<br />";} var change = "text_" + document.getElementById(key).id; document.getElementById(change).innerHTML += ": Storms"; backUp[temp-1] += ": Storms"; junkSong(document.getElementById(key), obj); continue;}
...
function linSoClick() {
	...
	ajoutHistorique(str, event.target.id);
	...
	else if (str.endsWith("magic") && Game.magic1) {Game.magic2 = true;}
	else if (str.endsWith("magic_2")) {Game.magic1 = false; Game.magic2 = false;}
	else if (str.endsWith("magic")) {Game.magic1 = true;}
	else if (str.endsWith("adults_wallet")) {if (Game.wallet1) {Game.wallet1 = false; Game.wallet2 = false; Game.wallet3 = false;} else {Game.wallet1 = true;}}
	else if (str.endsWith("bottle")) {if (Game.bottle3) {Game.bottle1 = false; Game.bottle2 = false; Game.bottle3 = false;} else if (Game.bottle2) {Game.bottle3 = true;} else if (Game.bottle1) {Game.bottle2 = true;} else {Game.bottle1 = true;}}
	...
	else if (str.endsWith("bow")) {if (Game.bow1) {Game.bow1 = false;} else {Game.bow1 = true;}}
...
function refreshLinSo() {
	if (linso) {
		...
		// On indique quel son a été obtenu sur quel check
		for (var i = 1; i <= 12; i++) {
			if (Check[Locations[lastItem + i]] != "unknown") {
				document.getElementById("linsoC" + i).style.opacity = 1; 
				document.getElementById("linsoC" + i).src = ItemImages[Items.indexOf(Check[Locations[lastItem + i]])]; 
				document.getElementById("linsoC" + i).style.width = "20px";
				document.getElementById("linsoC" + i).style.height = "20px"
			} else {document.getElementById("linsoC" + i).style.opacity = 0;}
		}
		var temp = 0;
		for (var i = 1; i <= 11; i++) {
			for (var j = 1; j <= 6; j++) {
				...
				else if (linsoOrder[temp] == "bow") {if (Game.bow1) {document.getElementById("linso" + i + j).src = Game.bow_img; document.getElementById("linso" + i + j).style.filter = "none"; document.getElementById("linso" + i + j).style.opacity = 1;} else {document.getElementById("linso" + i + j).src = Game.bow_img; document.getElementById("linso" + i + j).style.filter = "grayscale(100%)"; document.getElementById("linso" + i + j).style.opacity = .2;}}
				else if (linsoOrder[temp] == "magic") {if (Game.magic2)  {document.getElementById("linso" + i + j).src = Game.magic_2_img; document.getElementById("linso" + i + j).style.filter = "none"; document.getElementById("linso" + i + j).style.opacity = 1;} else if (Game.magic1){document.getElementById("linso" + i + j).src = Game.magic_img; document.getElementById("linso" + i + j).style.filter = "none"; document.getElementById("linso" + i + j).style.opacity = 1;} else {document.getElementById("linso" + i + j).src = Game.magic_img; document.getElementById("linso" + i + j).style.filter = "grayscale(100%)"; document.getElementById("linso" + i + j).style.opacity = .2;}}
...
function handleDungeonHighlights() {
	...
	if (Game.gen1) {Game.shadow = true; document.getElementById("dung7_icon").style.opacity=1; document.getElementById("text_dung7").style.opacity=.2;} else{document.getElementById("dung7_icon").style.opacity=.2; document.getElementById("text_dung7").style.opacity=1;}
	if (Game.gen2) {Game.spirit = true; document.getElementById("dung8_icon").style.opacity=1; document.getElementById("text_dung8").style.opacity=.2;} else{document.getElementById("dung8_icon").style.opacity=.2; document.getElementById("text_dung8").style.opacity=1;}
	if (Game.gen3) {Game.light = true; document.getElementById("dung9_icon").style.opacity=1; document.getElementById("text_dung9").style.opacity=.2;} else{document.getElementById("dung9_icon").style.opacity=.2; document.getElementById("text_dung9").style.opacity=1;}
