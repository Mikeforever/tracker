	...
	if (linso) {
		...
		for (var i = 1; i <= 11; i++) {
			for (var j = 1; j <= 6; j++) {
				...
				else if (Game[linsoOrder[temp]] || (Game[linsoOrder[temp] + 1])) {console.log(linsoOrder[temp] + " : " + Game[linsoOrder[temp]]); document.getElementById("linso" + i + j).style.filter = "none"; document.getElementById("linso" + i + j).style.opacity = 1;}
